...
create table sys_user (
  ...
  login_name        varchar(30)     not null管理                   comment '登录账号',
...
-- ----------------------------
-- 一级菜单
insert into sys_menu values('1', '系统管理', '0', '1', '#',                '',          'M', '0', '0', '', 'fa fa-gear',           'admin', sysdate(), '', null, '系统管理目录');
insert into sys_menu values('2', '系统监控', '0', '2', '#',                '',          'M', '0', '0', '', 'fa fa-video-camera',   'admin', sysdate(), '', null, '系统监控目录');
insert into sys_menu values('3', '系统工具', '0', '3', '#',                '',          'M', '0', '0', '', 'fa fa-bars',           'admin', sysdate(), '', null, '系统工具目录');
...
UPDATE sys_menu SET menu_name = '注册准备操作' WHERE menu_id = 1;
UPDATE sys_menu SET menu_name = '基础类概念注册' WHERE menu_id = 2;
UPDATE sys_menu SET menu_name = '描述类概念注册' WHERE menu_id = 3;
UPDATE sys_menu SET menu_name = '数据元目录' WHERE menu_id = 4;
